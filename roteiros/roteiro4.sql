...
--QUESTÃO 12--
SELECT d.dname, l.dlocation FROM department AS d,dept_locations as l WHERE d.dnumber = l.dnumber AND l.dlocation LIKE 'S%'; 
--QUESTÃO 13--
SELECT e.fname,d.dependent_name FROM employee AS e, dependent AS d WHERE e.ssn IS NOT NULL  AND e.ssn = d.essn;
--QUESTÃO 14--
...
-- QUESTÃO 18--
SELECT e.fname, d.dependent_name,d.relationship FROM employee AS e,project AS p, works_on AS w, dependent as d  
WHERE e.ssn = w.essn AND p.pnumber = w.pno AND p.pnumber = 91 AND d.essn = e.ssn;
